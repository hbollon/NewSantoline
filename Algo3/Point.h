...
public:
    BurningPoint(double x, double y, double dateIgnition, Point2D celluleQuiAMisFeu = Point2D(-1, -1)):
                                    Point2D(x, y), _dateIgnition(dateIgnition), _celluleQuiAMisFeu(celluleQuiAMisFeu){};
    BurningPoint(Point2D p, double dateIgnition, Point2D celluleQuiAMisFeu = Point2D(-1, -1)):
            Point2D(p), _dateIgnition(dateIgnition), _celluleQuiAMisFeu(celluleQuiAMisFeu){};
