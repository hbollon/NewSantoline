...
EllipseOpt::EllipseOpt(Point2D p, Vector3D rateOfSpread, float epsilon, float alpha, float phi):
m_coordonne(p) {
...
{
    return os << "Coordonne : " << o.coordonne() <<
    "Vecteur : " << o.vecteur()<<std::endl
    << "a : "<<o.a()<<" | "<<" b : "<<o.b()<<std::endl;

}

EllipseOpt::EllipseOpt(const EllipseOpt &other)
{
    m_vecteur = other.m_vecteur;
    m_coordonne = other.m_coordonne;
    m_a = other.m_a;
    m_b = other.m_b;
}
