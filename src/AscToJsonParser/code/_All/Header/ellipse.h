...
public:
  AEllipse(Vector3D wind, Vector3D slope, double aspect, double slope_value,
          double temp, double swl, Point2D top_left);
  AEllipse(Vector3D wind, Vector3D slope, double aspect, double slope_value, Point2D top_left);
  AEllipse();
