...
int orient(Point3D a, Point3D b, Point3D c)
{
...
//     if (m < 3) {
//         cout << "Not enough points to make convex hull" << endl;
//         return result;
//     }
...
//            // update q
//            if (orient(list[p], list[i], list[q]) == 2)
//                q = i;
//         }
