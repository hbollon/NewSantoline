...
public:
    Data(double _slope, const Vector3D &_slopeVector, double _aspect, const Vector3D &_wind, const Vector3D &_windSlope, AEllipse _ellipse) : _slope(_slope), _slopeVector(_slopeVector), _aspect(_aspect), _wind(_wind), _windSlopeVector(_windSlope), _ellipse(_ellipse) {}
