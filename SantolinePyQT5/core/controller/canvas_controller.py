...
class CanvasController(controller.AController):
    ...
    def addPointContour(self, point,button):
        self.canvasModel_.addPointContour(QgsPointXY(point.x(), point.y()), button)
        # self.accept()

    def addPointLargageEauABE(self, point, button):
        self.canvasModel_.addPointLargageEauABE(QgsPointXY(point.x(), point.y()), button)
        # self.accept()

    def addPointLargageEauHBE(self, point,button):
        self.canvasModel_.addPointLargageEauHBE(QgsPointXY(point.x(), point.y()),button)
        # self.accept()

    def addPointLargageCRetartant(self, point,button):
        self.canvasModel_.addPointLargageCRetartant(QgsPointXY(point.x(), point.y()),button)
        # self.accept()

    def addPointLargageHRetardant(self, point,button):
        self.canvasModel_.addPointLargageHRetardant(QgsPointXY(point.x(), point.y()),button)
        # self.accept()

    def addPointObstacle(self, point,button):
        self.canvasModel_.addPointObstacle(QgsPointXY(point.x(), point.y()),button)
        # self.accept()

    def addPointJalonnement(self, point,button):
        self.canvasModel_.addPointJalonnement(QgsPointXY(point.x(), point.y()),button)
        # self.accept()

    def addPointAppui(self, point,button):
        self.canvasModel_.addPointAppui(QgsPointXY(point.x(), point.y()),button)
        # self.accept()
    ...
    def removePointContour(self, point,button):
        self.canvasModel_.removePointContour(QgsPointXY(point.x(), point.y()),button)
        # self.accept()
        
    def removePointObstacle(self, point,button):
        self.canvasModel_.removePointObstacle(QgsPointXY(point.x(), point.y()),button)
        # self.accept()
        
    def removePointJalonnement(self, point,button):
        self.canvasModel_.removePointJalonnement(QgsPointXY(point.x(), point.y()),button)
        # self.accept()
        
    def removePointAppui(self, point,button):
        self.canvasModel_.removePointAppui(QgsPointXY(point.x(), point.y()),button)
        # self.accept()
    ...
    def clearPointAction(self):
        vertex_items = [i for i in self.view_.canvas_.scene().items() if issubclass(type(i), qgis.gui.QgsVertexMarker)]
