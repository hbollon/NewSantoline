...
class ParameterWindow(input_popup_view.InputPopup):
    ...
    def initUI(self):
        ...
        algorithme_choice_button_2.toggled.connect(
            self.controller_.algorithme_choice_button_2_clicked)
        algorithme_choice_button_3.toggled.connect(
            self.controller_.algorithme_choice_button_3_clicked)
        ...
        courbe_choice_button_no_hull = QRadioButton('No Hull')
        courbe_choice_button_no_hull.setChecked(False)
        ...
        courbe_choice_layout.addWidget(courbe_choice_button_no_hull)
        courbe_choice_button_concave.toggled.connect(
            self.controller_.courbe_choice_button_concave_clicked)
        courbe_choice_button_convexe.toggled.connect(
            self.controller_.courbe_choice_button_convexe_clicked)
        courbe_choice_button_no_hull.toggled.connect(
            self.controller_.courbe_choice_button_no_hull_clicked)
        ...
        algorithme_duree_label = QLabel(
            "Durée de propagation", algorithme_duree)
        ...
        algorithme_intervalle_layout.addWidget(
            self.algorithme_intervalle_heure_)
        algorithme_intervalle_layout.addWidget(
            QLabel("h", algorithme_intervalle))
        algorithme_intervalle_layout.addWidget(
            self.algorithme_intervalle_minute_)
        ...
        algorithme_reserve_label = QLabel(
            "Réserve en eau du sol", algorithme_reserve)
        ...
        algorithme_temperature_label = QLabel(
            "Température", algorithme_temperature)
        self.algorithme_temperature_spinbox_ = QSpinBox(algorithme_temperature)
        algorithme_temperature_label_unite = QLabel(
            "°C", algorithme_temperature)

        algorithme_temperature_layout.addWidget(algorithme_temperature_label)
        algorithme_temperature_layout.addWidget(
            self.algorithme_temperature_spinbox_)
        algorithme_temperature_layout.addWidget(
            algorithme_temperature_label_unite)
        ...
        algorithme_processus_label = QLabel(
            "Nombre de processeur", algorithme_processus)
        ...
        algorithme_processus_layout.addWidget(
            self.algorithme_processus_spinbox_)
        ...
        # Event binding
        self.algorithme_duree_heure_.valueChanged.connect(
            self.controller_.heure)
        self.algorithme_duree_minute_.valueChanged.connect(
            self.controller_.minute)
        self.algorithme_intervalle_heure_.valueChanged.connect(
            self.controller_.heureIntervalle)
        self.algorithme_intervalle_minute_.valueChanged.connect(
            self.controller_.minuteIntervalle)

        self.algorithme_reserve_spinbox_.valueChanged.connect(
            self.controller_.waterReserve)
        self.algorithme_temperature_spinbox_.valueChanged.connect(
            self.controller_.temperature)
        self.algorithme_processus_spinbox_.valueChanged.connect(
            self.controller_.process)
