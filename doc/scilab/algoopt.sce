//LISTFF : liste des point-vitesse
//LISTFF(IND)= MVT=list(MT,liste de vitesse)
// MT=[X;Y;T;TAU_X,TAU_Y,INDP,INDS,INDO,INDIC] est toujours sur une arete
// * T temps d'ignition
// * TAU vecteur perpendiculaire à l'arete dans le sens de la propagation
// * INDP indice du point précédent 
// * INDS indice du point suivant
// * INDO indice du point source
// * INDIC nature du point : INDIC= 0 point 'normal' une seule vitesse, INDIC=1 choc trois vitesses, INDIC=2 sommet deux vitesses, INDIC=3 cas d'un père de choc artificiel cf 'chocdansunecellule' 
